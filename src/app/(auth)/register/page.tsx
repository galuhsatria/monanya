        ...
        <div className="max-w-[25rem] mx-auto w-full">
          ...
          <div className="text-left mt-4">
            ...
            <p className="font-medium text-muted-foreground text-sm">
              Masukan email dan password anda untuk daftar akun
            </p>
          </div>

          <form
            onSubmit={handleSubmit(onSubmit)}
            className="mt-4 flex flex-col gap-4 font-medium"
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-1 border border-border rounded-md">
                <Input
                  ...
                  className="border-none rounded-e-none "
            ...
            <Button
              ...
              className="bg-accent dark:text-white rounded-full  hover:bg-[#27945f] "
              size={"lg"}
            >
              {isSubmitting ? (
